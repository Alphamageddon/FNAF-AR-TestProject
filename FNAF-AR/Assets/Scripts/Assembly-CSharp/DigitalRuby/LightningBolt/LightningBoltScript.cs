...
namespace DigitalRuby.LightningBolt
{
	...
	public class LightningBoltScript : MonoBehaviour
	{
		...
		public void Trigger()
		{
			...
			Vector3 vector = ((!(StartObject == null)) ? (StartObject.transform.position + StartPosition) : StartPosition);
			Vector3 vector2 = ((!(EndObject == null)) ? (EndObject.transform.position + EndPosition) : EndPosition);
			startIndex = 0;
