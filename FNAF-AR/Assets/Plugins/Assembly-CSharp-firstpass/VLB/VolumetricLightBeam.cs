...
namespace VLB
{
	...
	public class VolumetricLightBeam : MonoBehaviour
	{
		...
		public float coneAngle => Mathf.Atan2(coneRadiusEnd - coneRadiusStart, fallOffEnd) * 57.29578f * 2f;

		public float coneRadiusEnd => fallOffEnd * Mathf.Tan(spotAngle * (MathF.PI / 180f) * 0.5f);
