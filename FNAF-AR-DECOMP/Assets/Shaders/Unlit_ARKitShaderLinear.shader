Shader "Unlit/ARKitShaderLinear"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = (u_xlat0_d * float4(_Brightness, _Brightness, _Brightness, _Brightness));
          u_xlat16_0 = log2(u_xlat0_d);
          u_xlat16_0 = (u_xlat16_0 * float4(2.20000005, 2.20000005, 2.20000005, 2.20000005));
