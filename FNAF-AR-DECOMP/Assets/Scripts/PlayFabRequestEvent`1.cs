...
public sealed class PlayFabEvents.PlayFabRequestEvent<TRequest> : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public PlayFabEvents.PlayFabRequestEvent<TRequest>(object object, IntPtr method)
    {
        mem[1152921525945146144] = object;
        mem[1152921525945146152] = method;
        mem[1152921525945146128] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(TRequest request)
    {
        var val_23;
        var val_24;
        var val_26;
        ...
        goto label_22;
        label_60:
        PlayFab.AuthenticationModels.GetEntityTokenRequest val_3 = 1152921505321967616 + ((X21 + 72) << 4);
        val_26 = mem[(1152921505321967616 + (X21 + 72) << 4) + 304];
        goto label_58;
        label_18:
        PlayFab.AuthenticationModels.GetEntityTokenRequest val_4 = 1152921505321967616 + (X21 + 72);
        goto label_58;
        label_45:
        val_27 = mem[X21 + 72];
        val_27 = X21 + 72;
        if((request.Equals(obj:  mem[(1152921505321967616 + X21 + 72) + 296 + 8])) == false)
        {
            goto label_25;
        }
        ...
        label_50:
        val_29 = mem[(((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(request, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8];
        val_29 = (((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(request, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8;
        goto label_58;
        label_27:
        var val_30 = val_23;
        ...
        goto label_94;
        label_74:
        PlayFab.AuthenticationModels.GetEntityTokenRequest val_15 = 1152921505321967616 + ((X21 + 72) << 4);
        val_32 = mem[(1152921505321967616 + (X21 + 72) << 4) + 304];
        goto label_94;
        label_79:
        PlayFab.AuthenticationModels.GetEntityTokenRequest val_16 = 1152921505321967616 + (X21 + 72);
        goto label_94;
        label_12:
        if((val_1 & 1) == 0)
        {
        ...
        goto label_96;
        label_78:
        val_32 = mem[(VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(request, typeof(X21 + 24), slot: 0) + 8];
        val_32 = (VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(request, typeof(X21 + 24), slot: 0) + 8;
        goto label_94;
        label_15:
        var val_41 = val_20;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(TRequest request, System.AsyncCallback callback, object object)
    {
