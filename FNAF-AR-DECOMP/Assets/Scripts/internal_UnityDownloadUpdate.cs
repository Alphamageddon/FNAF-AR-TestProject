...
private sealed class UnityCVManager.internal_UnityDownloadUpdate : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public UnityCVManager.internal_UnityDownloadUpdate(object object, IntPtr method)
    {
        mem[1152921519032653328] = object;
        mem[1152921519032653336] = method;
        mem[1152921519032653312] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(int modelType, int bytesWritten, int totalBytesToWrite)
    {
        var val_10;
        var val_11;
        var val_12;
        ...
        label_37:
        var val_13 = val_7;
        val_13 = val_13 + bytesWritten;
        val_12 = val_12 + val_13;
        int val_3 = val_12 + 296;
        label_39:
        val_14 = mem[(((X23 + X24 + 72) + (((X23 + 176 + 8) + 16) + bytesWritten)) + 296) + 8];
        val_14 = (((X23 + X24 + 72) + (((X23 + 176 + 8) + 16) + bytesWritten)) + 296) + 8;
        goto label_41;
        label_19:
        var val_14 = val_9;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(int modelType, int bytesWritten, int totalBytesToWrite, System.AsyncCallback callback, object object)
    {
