...
namespace Dest.Math.Tests
{
    ...
    public class Test_IntrRay3Polygon3 : Test_Base
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            float val_10;
            var val_11;
            Dest.Math.Ray3 val_1 = 48353.CreateRay3(ray:  this.Ray);
            Dest.Math.Plane3 val_4 = 48353.CreatePlane3(plane:  this.PolygonPlane);
            val_8 = val_3;
            val_9 = V2.16B;
            ...
            val_5.UpdateEdges();
            bool val_7 = Dest.Math.Intersection.FindRay3Polygon3(ray: ref  new Dest.Math.Ray3() {Center = new UnityEngine.Vector3() {x = val_3, y = val_3, z = val_3}, Direction = new UnityEngine.Vector3() {x = val_3, y = val_2, z = val_2}}, polygon:  val_5, info: out  new Dest.Math.Ray3Polygon3Intr() {Point = new UnityEngine.Vector3() {x = 0f, y = 0f, z = val_3}});
            val_7.FiguresColor();
