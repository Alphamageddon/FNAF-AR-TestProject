...
namespace Dest.Math.Tests
{
    ...
    public class Test_IntrRay3Circle3 : Test_Base
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            float val_7;
            float val_8;
            Dest.Math.Ray3 val_1 = 48351.CreateRay3(ray:  this.Ray);
            Dest.Math.Circle3 val_4 = 48351.CreateCircle3(circle:  this.Circle);
            bool val_9 = Dest.Math.Intersection.FindRay3Circle3(ray: ref  new Dest.Math.Ray3() {Center = new UnityEngine.Vector3() {x = val_3, y = val_3, z = val_3}, Direction = new UnityEngine.Vector3() {x = val_3, y = val_2, z = val_2}}, circle: ref  new Dest.Math.Circle3() {Center = new UnityEngine.Vector3() {x = val_8, y = val_8, z = val_8}, Axis0 = new UnityEngine.Vector3() {x = val_8, y = val_6, z = val_6}, Axis1 = new UnityEngine.Vector3() {x = val_6, y = val_6, z = val_7}, Normal = new UnityEngine.Vector3() {x = val_7, y = val_7, z = val_7}, Radius = val_5}, info: out  new Dest.Math.Ray3Circle3Intr() {Point = new UnityEngine.Vector3() {x = 0f, y = 0f, z = val_8}});
            val_9.FiguresColor();
