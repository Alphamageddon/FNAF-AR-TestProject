...
namespace Dest.Math.Tests
{
    ...
    public class Test_DistLine2Segment2 : Test_Base
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            float val_4;
            float val_5;
            Dest.Math.Line2 val_1 = 48274.CreateLine2(line:  this.Line);
            Dest.Math.Segment2 val_2 = val_1.Center.x.CreateSegment2(p0:  this.P0, p1:  this.P1);
            float val_6 = Dest.Math.Distance.Line2Segment2(line: ref  new Dest.Math.Line2() {Center = new UnityEngine.Vector2() {x = 0f, y = ???}, Direction = new UnityEngine.Vector2() {x = ???, y = ???}}, segment: ref  new Dest.Math.Segment2() {P0 = new UnityEngine.Vector2() {x = val_4, y = val_4}, P1 = new UnityEngine.Vector2() {x = val_4, y = val_4}, Center = new UnityEngine.Vector2() {x = val_5, y = val_5}, Direction = new UnityEngine.Vector2() {x = val_5, y = val_5}, Extent = val_3}, closestPoint0: out  new UnityEngine.Vector2() {x = 0f, y = 0f}, closestPoint1: out  new UnityEngine.Vector2() {x = 0f, y = 0f});
            0f.FiguresColor();
