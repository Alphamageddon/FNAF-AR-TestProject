...
namespace Dest.Math.Tests
{
    ...
    public class Test_IntrLine2Triangle2 : Test_Base
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            Dest.Math.Line2 val_1 = 48327.CreateLine2(line:  this.Line);
            Dest.Math.Triangle2 val_2 = val_1.Center.x.CreateTriangle2(v0:  this.V0, v1:  this.V1, v2:  this.V2);
            bool val_7 = Dest.Math.Intersection.FindLine2Triangle2(line: ref  new Dest.Math.Line2() {Center = new UnityEngine.Vector2() {x = ???, y = ???}, Direction = new UnityEngine.Vector2() {x = ???, y = ???}}, triangle: ref  new Dest.Math.Triangle2() {V0 = new UnityEngine.Vector2() {x = val_4, y = val_4}, V1 = new UnityEngine.Vector2() {x = val_4, y = val_4}, V2 = new UnityEngine.Vector2() {x = val_3, y = val_3}}, info: out  new Dest.Math.Line2Triangle2Intr() {Point0 = new UnityEngine.Vector2() {x = 0f, y = 0f}, Point1 = new UnityEngine.Vector2() {x = 0f}});
            val_7.FiguresColor();
            val_7.DrawLine(line: ref  new Dest.Math.Line2() {Center = new UnityEngine.Vector2() {x = ???, y = ???}, Direction = new UnityEngine.Vector2() {x = ???, y = ???}});
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public Test_IntrLine2Triangle2()
        {
