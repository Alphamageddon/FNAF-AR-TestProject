...
public sealed class Crashes.ShouldProcessErrorReportHandler : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public Crashes.ShouldProcessErrorReportHandler(object object, IntPtr method)
    {
        mem[1152921526221202640] = object;
        mem[1152921526221202648] = method;
        mem[1152921526221202624] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual bool Invoke(Microsoft.AppCenter.Unity.Crashes.ErrorReport errorReport)
    {
        var val_23;
        var val_24;
        var val_26;
        ...
        return (bool)val_23 & 1;
        label_75:
        Microsoft.AppCenter.Unity.Crashes.ErrorReport val_15 = 1152921505334960128 + ((X21 + 72) << 4);
        val_32 = mem[(1152921505334960128 + (X21 + 72) << 4) + 304];
        return (bool)val_23 & 1;
        label_81:
        Microsoft.AppCenter.Unity.Crashes.ErrorReport val_16 = 1152921505334960128 + (X21 + 72);
        return (bool)val_23 & 1;
        label_12:
        if((val_1 & 1) == 0)
        {
