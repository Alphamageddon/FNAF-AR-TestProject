...
namespace Systems.Server.PlayFabProxy
{
    ...
    public class PlayFabBestStreakLeaderboardGetter : BestStreakLeaderboardGetter
    {
        // Fields
        [System.Runtime.InteropServices.ComVisibleAttribute]
        ...
        public void GetLeaderboard()
        {
            ...
            PlayFab.PlayFabClientAPI.GetLeaderboard(request:  new PlayFab.ClientModels.GetLeaderboardRequest(), resultCallback:  new System.Action<PlayFab.ClientModels.GetLeaderboardResult>(object:  this, method:  System.Void Systems.Server.PlayFabProxy.PlayFabBestStreakLeaderboardGetter::SuccessCallback(PlayFab.ClientModels.GetLeaderboardResult result)), errorCallback:  new System.Action<PlayFab.PlayFabError>(object:  this, method:  System.Void Systems.Server.PlayFabProxy.PlayFabBestStreakLeaderboardGetter::ErrorCallback(PlayFab.PlayFabError error)), customData:  0, extraHeaders:  0);
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        private void SuccessCallback(PlayFab.ClientModels.GetLeaderboardResult result)
        {
            ...
            if(mem[1152921523356807632] == 0)
            {
                    return;
            }
            
            mem[1152921523356807632].Invoke(obj:  val_1);
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public PlayFabBestStreakLeaderboardGetter()
        {
