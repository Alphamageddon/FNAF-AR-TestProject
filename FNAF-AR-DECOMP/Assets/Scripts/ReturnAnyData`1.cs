...
public sealed class GetAccessToData.ReturnAnyData<T> : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public GetAccessToData.ReturnAnyData<T>(object object, IntPtr method)
    {
        mem[1152921525245697856] = object;
        mem[1152921525245697864] = method;
        mem[1152921525245697840] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(T alertData)
    {
        var val_22;
        var val_23;
        var val_25;
        ...
        goto label_22;
        label_60:
        object val_3 = 1152921504627666944 + ((X21 + 72) << 4);
        val_25 = mem[(1152921504627666944 + (X21 + 72) << 4) + 304];
        goto label_58;
        label_18:
        object val_4 = 1152921504627666944 + (X21 + 72);
        goto label_58;
        label_45:
        val_26 = mem[X21 + 72];
        val_26 = X21 + 72;
        ...
        goto label_58;
        label_22:
        var val_28 = (VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(alertData, typeof(val_2), slot: 0);
        goto label_58;
        label_48:
        ...
        label_50:
        val_28 = mem[(((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(alertData, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8];
        val_28 = (((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(alertData, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8;
        goto label_58;
        label_27:
        var val_29 = val_22;
        ...
        goto label_94;
        label_74:
        object val_14 = 1152921504627666944 + ((X21 + 72) << 4);
        val_31 = mem[(1152921504627666944 + (X21 + 72) << 4) + 304];
        goto label_94;
        label_79:
        object val_15 = 1152921504627666944 + (X21 + 72);
        goto label_94;
        label_12:
        if((val_1 & 1) == 0)
        {
        ...
        goto label_96;
        label_78:
        val_31 = mem[(VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(alertData, typeof(X21 + 24), slot: 0) + 8];
        val_31 = (VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(alertData, typeof(X21 + 24), slot: 0) + 8;
        goto label_94;
        label_15:
        var val_40 = val_19;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(T alertData, System.AsyncCallback callback, object object)
    {
