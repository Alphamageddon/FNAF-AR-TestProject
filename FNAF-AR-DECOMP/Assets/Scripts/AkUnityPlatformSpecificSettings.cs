...
public class AkUnityPlatformSpecificSettings : IDisposable
{
    ...
    public virtual void Dispose()
    {
                ...
                if(this.swigCMemOwn != false)
        {
            ...
            AkSoundEnginePINVOKE.CSharp_delete_AkUnityPlatformSpecificSettings(jarg1:  this.swigCPtr);
        }
    ...
    public AkUnityPlatformSpecificSettings()
    {
        ...
        this.swigCPtr = AkSoundEnginePINVOKE.CSharp_new_AkUnityPlatformSpecificSettings();
    }
