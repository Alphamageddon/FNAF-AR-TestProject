...
public sealed class UnityCVManager.DownloadComplete : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public UnityCVManager.DownloadComplete(object object, IntPtr method)
    {
        mem[1152921519029391888] = object;
        mem[1152921519029391896] = method;
        mem[1152921519029391872] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(int modelIndex, bool failed)
    {
        var val_16;
        var val_17;
        var val_18;
        ...
        label_37:
        var val_19 = val_13;
        val_19 = val_19 + failed;
        val_18 = val_18 + val_19;
        bool val_4 = val_18 + 296;
        label_39:
        val_19 = mem[(((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + (failed & 1))) + 296) + 8];
        val_19 = (((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + (failed & 1))) + 296) + 8;
        label_22:
        bool val_5 = failed;
        goto label_41;
        label_19:
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(int modelIndex, bool failed, System.AsyncCallback callback, object object)
    {
        bool val_1 = failed;
