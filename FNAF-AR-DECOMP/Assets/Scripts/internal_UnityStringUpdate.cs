...
private sealed class UnityCVManager.internal_UnityStringUpdate : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public UnityCVManager.internal_UnityStringUpdate(object object, IntPtr method)
    {
        mem[1152921519033721360] = object;
        mem[1152921519033721368] = method;
        mem[1152921519033721344] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(IntPtr str, int numChars)
    {
        var val_10;
        var val_11;
        var val_12;
        ...
        label_39:
        val_13 = mem[(((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + numChars)) + 296) + 8];
        val_13 = (((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + numChars)) + 296) + 8;
        goto label_41;
        label_19:
        var val_14 = val_9;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(IntPtr str, int numChars, System.AsyncCallback callback, object object)
    {
