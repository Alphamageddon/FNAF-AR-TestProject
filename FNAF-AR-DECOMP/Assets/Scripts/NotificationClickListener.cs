...
public sealed class NotificationCenterViewBuilder.NotificationClickListener : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public NotificationCenterViewBuilder.NotificationClickListener(object object, IntPtr method)
    {
        mem[1152921525955987536] = object;
        mem[1152921525955987544] = method;
        mem[1152921525955987520] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual bool Invoke(GetSocialSdk.Core.Notification notification)
    {
        var val_23;
        var val_24;
        var val_26;
        ...
        goto label_22;
        label_60:
        GetSocialSdk.Core.Notification val_3 = 1152921505326653440 + ((X21 + 72) << 4);
        val_26 = mem[(1152921505326653440 + (X21 + 72) << 4) + 304];
        goto label_23;
        label_18:
        val_27 = notification;
        GetSocialSdk.Core.Notification val_4 = 1152921505326653440 + (X21 + 72);
        goto label_52;
        label_45:
        if((val_27 & 1) == 0)
        {
        ...
        label_50:
        val_29 = mem[(((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(notification, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8];
        val_29 = (((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(notification, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8;
        label_30:
        val_27 = X21 + 72;
        goto label_52;
        label_27:
        ...
        return (bool)val_23 & 1;
        label_75:
        GetSocialSdk.Core.Notification val_15 = 1152921505326653440 + ((X21 + 72) << 4);
        val_32 = mem[(1152921505326653440 + (X21 + 72) << 4) + 304];
        return (bool)val_23 & 1;
        label_81:
        GetSocialSdk.Core.Notification val_16 = 1152921505326653440 + (X21 + 72);
        return (bool)val_23 & 1;
        label_12:
        if((val_1 & 1) == 0)
        {
        ...
        goto label_98;
        label_79:
        val_32 = mem[(VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(notification, typeof(X21 + 24), slot: 0) + 8];
        val_32 = (VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(notification, typeof(X21 + 24), slot: 0) + 8;
        return (bool)val_23 & 1;
        label_15:
        var val_41 = val_20;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(GetSocialSdk.Core.Notification notification, System.AsyncCallback callback, object object)
    {
