...
namespace Ionic.Zlib
{
    ...
    public class DeflateStream : Stream
    {
        ...
        public DeflateStream(System.IO.Stream stream, Ionic.Zlib.CompressionMode mode, Ionic.Zlib.CompressionLevel level, bool leaveOpen)
        {
            ...
            this._baseStream = new Ionic.Zlib.ZlibBaseStream(stream:  stream, compressionMode:  mode, level:  level, flavor:  159, leaveOpen:  leaveOpen);
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        ...
        public virtual void set_FlushMode(Ionic.Zlib.FlushType value)
        {
            ...
            System.ObjectDisposedException val_1 = new System.ObjectDisposedException(objectName:  "DeflateStream");
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        ...
        public void set_BufferSize(int value)
        {
            ...
            val_5 = val_1;
            val_1 = new System.ObjectDisposedException(objectName:  "DeflateStream");
            goto label_6;
            label_3:
        ...
        public Ionic.Zlib.CompressionStrategy get_Strategy()
        {
            if(this._baseStream != null)
            {
                    return (Ionic.Zlib.CompressionStrategy)this._baseStream.Strategy;
            }
            
            return (Ionic.Zlib.CompressionStrategy)this._baseStream.Strategy;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void set_Strategy(Ionic.Zlib.CompressionStrategy value)
        {
            if(this._disposed != true)
            {
        ...
        public static byte[] CompressString(string s)
        {
            ...
            new Ionic.Zlib.DeflateStream() = new Ionic.Zlib.DeflateStream(stream:  val_1, mode:  0, level:  9, leaveOpen:  false);
            Ionic.Zlib.ZlibBaseStream.CompressString(s:  s, compressor:  new Ionic.Zlib.DeflateStream());
            var val_4 = 0;
            val_4 = val_4 + 1;
            val_1.Dispose();
            if(0 == 0)
        ...
        public static byte[] CompressBuffer(byte[] b)
        {
            System.IO.MemoryStream val_1 = new System.IO.MemoryStream();
            new Ionic.Zlib.DeflateStream() = new Ionic.Zlib.DeflateStream(stream:  val_1, mode:  0, level:  9, leaveOpen:  false);
            Ionic.Zlib.ZlibBaseStream.CompressBuffer(b:  b, compressor:  new Ionic.Zlib.DeflateStream());
            var val_4 = 0;
            val_4 = val_4 + 1;
            val_1.Dispose();
            if(0 == 0)
        ...
        public static string UncompressString(byte[] compressed)
        {
            ...
            new Ionic.Zlib.DeflateStream() = new Ionic.Zlib.DeflateStream(stream:  val_1, mode:  1, level:  6, leaveOpen:  false);
            if(val_1 != null)
            {
                    var val_5 = 0;
                val_5 = val_5 + 1;
            ...
            if(35 == 35)
            {
                    return (string)Ionic.Zlib.ZlibBaseStream.UncompressString(compressed:  compressed, decompressor:  new Ionic.Zlib.DeflateStream());
            }
        ...
        public static byte[] UncompressBuffer(byte[] compressed)
        {
            ...
            if(35 == 35)
            {
                    return (System.Byte[])Ionic.Zlib.ZlibBaseStream.UncompressBuffer(compressed:  compressed, decompressor:  new Ionic.Zlib.DeflateStream());
            }
