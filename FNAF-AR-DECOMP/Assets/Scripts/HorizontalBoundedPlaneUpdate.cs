...
public sealed class IxBoundedPlaneDeliverer.HorizontalBoundedPlaneUpdate : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public IxBoundedPlaneDeliverer.HorizontalBoundedPlaneUpdate(object object, IntPtr method)
    {
        mem[1152921523092650576] = object;
        mem[1152921523092650584] = method;
        mem[1152921523092650560] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(IllumixHorizontalBoundedPlane plane)
    {
        var val_23;
        var val_24;
        var val_26;
        ...
        goto label_22;
        label_60:
        IllumixHorizontalBoundedPlane val_3 = 1152921505068453888 + ((X21 + 72) << 4);
        val_26 = mem[(1152921505068453888 + (X21 + 72) << 4) + 304];
        goto label_58;
        label_18:
        IllumixHorizontalBoundedPlane val_4 = 1152921505068453888 + (X21 + 72);
        goto label_58;
        label_45:
        val_27 = mem[X21 + 72];
        val_27 = X21 + 72;
        if((plane.Equals(obj:  mem[(1152921505068453888 + X21 + 72) + 296 + 8])) == false)
        {
            goto label_25;
        }
        ...
        goto label_94;
        label_74:
        IllumixHorizontalBoundedPlane val_15 = 1152921505068453888 + ((X21 + 72) << 4);
        val_32 = mem[(1152921505068453888 + (X21 + 72) << 4) + 304];
        goto label_94;
        label_79:
        IllumixHorizontalBoundedPlane val_16 = 1152921505068453888 + (X21 + 72);
        goto label_94;
        label_12:
        if((val_1 & 1) == 0)
        {
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(IllumixHorizontalBoundedPlane plane, System.AsyncCallback callback, object object)
    {
