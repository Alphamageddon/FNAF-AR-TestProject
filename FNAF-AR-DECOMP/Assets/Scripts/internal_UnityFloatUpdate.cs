...
private sealed class UnityCVManager.internal_UnityFloatUpdate : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public UnityCVManager.internal_UnityFloatUpdate(object object, IntPtr method)
    {
        mem[1152921519031601680] = object;
        mem[1152921519031601688] = method;
        mem[1152921519031601664] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(IntPtr floats, int length)
    {
        var val_10;
        var val_11;
        var val_12;
        ...
        label_37:
        var val_13 = val_7;
        val_13 = val_13 + length;
        val_12 = val_12 + val_13;
        int val_3 = val_12 + 296;
        label_39:
        val_13 = mem[(((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + length)) + 296) + 8];
        val_13 = (((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + length)) + 296) + 8;
        goto label_41;
        label_19:
        var val_14 = val_9;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(IntPtr floats, int length, System.AsyncCallback callback, object object)
    {
