...
namespace TMPro.Examples
{
    ...
    public class TMP_FrameRateCounter : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            TMPro.TextMeshPro val_4 = val_3.AddComponent<TMPro.TextMeshPro>();
            this.m_TextMeshPro = val_4;
            val_4.font = UnityEngine.Resources.Load<TMPro.TMP_FontAsset>(path:  "Fonts & Materials/LiberationSans SDF");
            UnityEngine.Material val_6 = UnityEngine.Resources.Load<UnityEngine.Material>(path:  "Fonts & Materials/LiberationSans SDF - Overlay");
            UnityEngine.Transform val_7 = val_3.transform;
            this.m_frameCounter_transform = val_7;
            val_7.SetParent(p:  this.m_camera.transform);
            UnityEngine.Quaternion val_9 = UnityEngine.Quaternion.identity;
            this.m_frameCounter_transform.localRotation = new UnityEngine.Quaternion() {x = val_9.x, y = val_9.y, z = val_9.z, w = val_9.w};
        ...
        {
            UnityEngine.Camera val_10 = this;
            if(anchor_position > 3)
            {
                    return;
            }
            
            var val_10 = 52945856 + (anchor_position) << 2;
            val_10 = val_10 + 52945856;
            goto (52945856 + (anchor_position) << 2 + 52945856);
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
