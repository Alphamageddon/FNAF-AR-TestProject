...
public class AkAudioSourceChangeCallbackInfo : IDisposable
{
    ...
    // Properties
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public bool bOtherAudioPlaying { get; }
    ...
    public virtual void Dispose()
    {
                ...
                if(this.swigCMemOwn != false)
        {
            ...
            AkSoundEnginePINVOKE.CSharp_delete_AkAudioSourceChangeCallbackInfo(jarg1:  this.swigCPtr);
        }
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public bool get_bOtherAudioPlaying()
    {
        return AkSoundEnginePINVOKE.CSharp_AkAudioSourceChangeCallbackInfo_bOtherAudioPlaying_get(jarg1:  this.swigCPtr);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public AkAudioSourceChangeCallbackInfo()
    {
        this.swigCMemOwn = true;
        this.swigCPtr = AkSoundEnginePINVOKE.CSharp_new_AkAudioSourceChangeCallbackInfo();
    }
