...
namespace GameUI.CanvasFlow
{
    ...
    public class GameProject_Alpine_CanvasController_DailyChallenges : GameProject_Alpine_SubCanvasController
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        protected override void CanvasWillAppear()
        {
            Systems.Analytics.AnalyticsCalls.FireEvent_Ui_UserHitNavigationButton_DailyChallenges();
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public GameProject_Alpine_CanvasController_DailyChallenges()
        {
            mem[1152921524966599280] = 0;
