...
namespace SRDebugger.Services
{
    ...
    public sealed class PinEntryCompleteCallback : MulticastDelegate
    {
        ...
        {
            mem[1152921522981658976] = object;
            mem[1152921522981658984] = method;
            mem[1152921522981658960] = method;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public virtual void Invoke(bool validPinEntered)
        {
            ...
            label_32:
            bool val_9 = validPinEntered;
            goto label_41;
            label_40:
            validPinEntered = validPinEntered;
            label_41:
            val_23 = val_23 + 1;
            if(val_23 != (X24 + 24))
            {
