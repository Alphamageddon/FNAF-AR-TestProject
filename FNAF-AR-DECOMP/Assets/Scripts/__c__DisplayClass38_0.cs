...
private sealed class CPUData.<>c__DisplayClass38_0
{
    // Fields
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public ProtoData.CPU_DATA.Types.ENTRY data;
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public Game.ItemDefinition.Data.DataDefinitions.CPUData <>4__this;
    
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public CPUData.<>c__DisplayClass38_0()
    {
    ...
    internal void <.ctor>b__0(Game.Localization.ILocalization localization)
    {
        ...
        label_9:
        this.<>4__this.AnimatronicName = GetLocalizedString(localizedStringId:  val_3, originalString:  val_3);
    }
