...
public sealed class AkAudioInputManager.AudioFormatInteropDelegate : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public AkAudioInputManager.AudioFormatInteropDelegate(object object, IntPtr method)
    {
        mem[1152921519384602000] = object;
        mem[1152921519384602008] = method;
        mem[1152921519384601984] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(uint playingID, IntPtr format)
    {
        ...
        label_39:
        val_13 = mem[(((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + format)) + 296) + 8];
        val_13 = (((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + format)) + 296) + 8;
        goto label_41;
        label_19:
        var val_14 = val_9;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(uint playingID, IntPtr format, System.AsyncCallback callback, object object)
    {
