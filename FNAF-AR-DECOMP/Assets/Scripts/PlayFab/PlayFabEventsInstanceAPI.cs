...
namespace PlayFab
{
    ...
    public class PlayFabEventsInstanceAPI : IPlayFabInstanceApi
    {
        ...
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public PlayFabEventsInstanceAPI(PlayFab.PlayFabAuthenticationContext context)
        {
            if(context != null)
            {
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public PlayFabEventsInstanceAPI(PlayFab.PlayFabApiSettings settings, PlayFab.PlayFabAuthenticationContext context)
        {
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void WriteEvents(PlayFab.EventsModels.WriteEventsRequest request, System.Action<PlayFab.EventsModels.WriteEventsResponse> resultCallback, System.Action<PlayFab.PlayFabError> errorCallback, object customData, System.Collections.Generic.Dictionary<string, string> extraHeaders)
        {
            ...
            PlayFab.Internal.PlayFabHttp.MakeApiCall<PlayFab.EventsModels.WriteEventsResponse>(apiEndpoint:  "/Event/WriteEvents", request:  request, authType:  4, resultCallback:  resultCallback, errorCallback:  errorCallback, customData:  customData, extraHeaders:  extraHeaders, authenticationContext:  val_1, apiSettings:  val_2, instanceApi:  this);
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void WriteTelemetryEvents(PlayFab.EventsModels.WriteEventsRequest request, System.Action<PlayFab.EventsModels.WriteEventsResponse> resultCallback, System.Action<PlayFab.PlayFabError> errorCallback, object customData, System.Collections.Generic.Dictionary<string, string> extraHeaders)
        {
            PlayFab.PlayFabAuthenticationContext val_1;
            PlayFab.PlayFabApiSettings val_2;
            var val_3;
