...
namespace PlayFab
{
    ...
    public class PlayFabCloudScriptInstanceAPI : IPlayFabInstanceApi
    {
        ...
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public PlayFabCloudScriptInstanceAPI(PlayFab.PlayFabAuthenticationContext context)
        {
            if(context != null)
            {
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public PlayFabCloudScriptInstanceAPI(PlayFab.PlayFabApiSettings settings, PlayFab.PlayFabAuthenticationContext context)
        {
