...
public sealed class IxVerticalSemanticPlaneDeliverer.TileLabel : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public IxVerticalSemanticPlaneDeliverer.TileLabel(object object, IntPtr method)
    {
        mem[1152921523127892464] = object;
        mem[1152921523127892472] = method;
        mem[1152921523127892448] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(SharedTechAssets.Scripts.IllumixEngine.IllumixObjects.IxSemanticVerticalPlane plane, UnityEngine.Vector2 key, string label, float confidence)
    {
        var val_23;
        var val_24;
        var val_26;
        ...
        goto label_22;
        label_60:
        SharedTechAssets.Scripts.IllumixEngine.IllumixObjects.IxSemanticVerticalPlane val_3 = 1152921505160413184 + ((X22 + 72) << 4);
        val_26 = mem[(1152921505160413184 + (X22 + 72) << 4) + 304];
        goto label_58;
        label_18:
        SharedTechAssets.Scripts.IllumixEngine.IllumixObjects.IxSemanticVerticalPlane val_4 = 1152921505160413184 + val_23;
        goto label_58;
        label_45:
        if((plane.Equals(obj:  label)) == false)
        {
            goto label_25;
        }
        ...
        goto label_94;
        label_74:
        SharedTechAssets.Scripts.IllumixEngine.IllumixObjects.IxSemanticVerticalPlane val_15 = 1152921505160413184 + ((X22 + 72) << 4);
        val_31 = mem[(1152921505160413184 + (X22 + 72) << 4) + 304];
        goto label_94;
        label_79:
        SharedTechAssets.Scripts.IllumixEngine.IllumixObjects.IxSemanticVerticalPlane val_16 = 1152921505160413184 + (X22 + 72);
        goto label_94;
        label_12:
        if((val_1 & 1) == 0)
        {
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(SharedTechAssets.Scripts.IllumixEngine.IllumixObjects.IxSemanticVerticalPlane plane, UnityEngine.Vector2 key, string label, float confidence, System.AsyncCallback callback, object object)
    {
