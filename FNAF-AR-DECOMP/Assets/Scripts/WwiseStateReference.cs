...
public class WwiseStateReference : WwiseGroupValueObjectReference
{
    ...
    {
        null = null;
        return (WwiseObjectType)WwiseStateReference.MyWwiseObjectType;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public override WwiseObjectReference get_GroupObjectReference()
    {
        return (WwiseObjectReference)this.WwiseStateGroupReference;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    ...
    {
        null = null;
        return (WwiseObjectType)WwiseStateReference.MyGroupWwiseObjectType;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    private static WwiseStateReference()
    {
        WwiseStateReference.MyWwiseObjectType = 8;
        WwiseStateReference.MyGroupWwiseObjectType = 9;
    }
