...
public sealed class GetAccessToData.ReturnData : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public GetAccessToData.ReturnData(object object, IntPtr method)
    {
        mem[1152921525245135168] = object;
        mem[1152921525245135176] = method;
        mem[1152921525245135152] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(Google.Protobuf.IMessage data)
    {
        var val_22;
        var val_23;
        var val_25;
        ...
        goto label_22;
        label_60:
        Google.Protobuf.IMessage val_3 = 1152921504996728832 + ((X21 + 72) << 4);
        val_25 = mem[(1152921504996728832 + (X21 + 72) << 4) + 304];
        goto label_58;
        label_18:
        Google.Protobuf.IMessage val_4 = 1152921504996728832 + (X21 + 72);
        goto label_58;
        label_45:
        val_26 = mem[X21 + 72];
        val_26 = X21 + 72;
        ...
        goto label_58;
        label_22:
        var val_28 = (VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(data, typeof(val_2), slot: 0);
        goto label_58;
        label_48:
        ...
        label_50:
        val_28 = mem[(((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(data, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8];
        val_28 = (((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(data, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8;
        goto label_58;
        label_27:
        var val_29 = val_22;
        ...
        goto label_94;
        label_74:
        Google.Protobuf.IMessage val_14 = 1152921504996728832 + ((X21 + 72) << 4);
        val_31 = mem[(1152921504996728832 + (X21 + 72) << 4) + 304];
        goto label_94;
        label_79:
        Google.Protobuf.IMessage val_15 = 1152921504996728832 + (X21 + 72);
        goto label_94;
        label_12:
        if((val_1 & 1) == 0)
        {
        ...
        goto label_96;
        label_78:
        val_31 = mem[(VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(data, typeof(X21 + 24), slot: 0) + 8];
        val_31 = (VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(data, typeof(X21 + 24), slot: 0) + 8;
        goto label_94;
        label_15:
        var val_40 = val_19;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(Google.Protobuf.IMessage data, System.AsyncCallback callback, object object)
    {
