...
public sealed class UnityCVManager.DownloadProgressUpdate : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public UnityCVManager.DownloadProgressUpdate(object object, IntPtr method)
    {
        mem[1152921519028853776] = object;
        mem[1152921519028853784] = method;
        mem[1152921519028853760] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(int modelIndex, int bytesWritten, int bytesToWrite)
    {
        var val_10;
        var val_11;
        var val_12;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(int modelIndex, int bytesWritten, int bytesToWrite, System.AsyncCallback callback, object object)
    {
