...
private sealed class UnityCVManager.internal_UnityDownloadComplete : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public UnityCVManager.internal_UnityDownloadComplete(object object, IntPtr method)
    {
        mem[1152921519033191440] = object;
        mem[1152921519033191448] = method;
        mem[1152921519033191424] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(int modelType, int failed)
    {
        var val_10;
        var val_11;
        var val_12;
        ...
        label_37:
        var val_13 = val_7;
        val_13 = val_13 + failed;
        val_12 = val_12 + val_13;
        int val_3 = val_12 + 296;
        label_39:
        val_13 = mem[(((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + failed)) + 296) + 8];
        val_13 = (((X22 + X23 + 72) + (((X22 + 176 + 8) + 16) + failed)) + 296) + 8;
        goto label_41;
        label_19:
        var val_14 = val_9;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(int modelType, int failed, System.AsyncCallback callback, object object)
    {
