...
namespace Server
{
    ...
    public class GameSparksBestStreakLeaderboardGetter : BestStreakLeaderboardGetter
    {
        // Fields
        [System.Runtime.InteropServices.ComVisibleAttribute]
        private const string ClassName = "BestStreakLeaderboardGetter";
        [System.Runtime.InteropServices.ComVisibleAttribute]
        ...
        {
            this.BestStreakLeaderboardUpdated = callback;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void GetLeaderboard()
        {
            ...
            if(val_1 != null)
            {
                    GameSparks.Api.Requests.LeaderboardDataRequest val_2 = val_1.SetLeaderboardShortCode(leaderboardShortCode:  "BEST_STREAK_LB");
            }
            else
            {
                    GameSparks.Api.Requests.LeaderboardDataRequest val_3 = val_1.SetLeaderboardShortCode(leaderboardShortCode:  "BEST_STREAK_LB");
            }
            
            GameSparks.Api.Requests.LeaderboardDataRequest val_4 = val_1.SetEntryCount(entryCount:  100);
            val_1.Send(callback:  new System.Action<GameSparks.Api.Responses.LeaderboardDataResponse>(object:  this, method:  System.Void Server.GameSparksBestStreakLeaderboardGetter::OnLeaderboardDataResponse(GameSparks.Api.Responses.LeaderboardDataResponse response)));
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        private void OnLeaderboardDataResponse(GameSparks.Api.Responses.LeaderboardDataResponse response)
        {
            ...
            if(val_18.HasErrors != false)
            {
                ...
                ConsoleLogger.LogError(className:  "BestStreakLeaderboardGetter", functionName:  "OnLeaderboardDataResponse", logString:  val_19);
                return;
            }
            ...
            System.Nullable<System.Int64> val_14 = val_9.GetNumberValue(key:  "bestStreak");
            ...
            if(mem[1152921523192259664] == 0)
            {
                    return;
            }
            
            mem[1152921523192259664].Invoke(obj:  val_5);
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public GameSparksBestStreakLeaderboardGetter()
        {
