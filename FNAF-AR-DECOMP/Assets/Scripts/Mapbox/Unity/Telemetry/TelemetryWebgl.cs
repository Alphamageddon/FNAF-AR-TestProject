...
namespace Mapbox.Unity.Telemetry
{
    ...
    public class TelemetryWebgl : ITelemetryLibrary
    {
        ...
        {
            null = null;
            return (Mapbox.Unity.Telemetry.ITelemetryLibrary)Mapbox.Unity.Telemetry.TelemetryWebgl._instance;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        ...
        private string GetPostBody()
        {
            ...
            val_2.Add(key:  "userAgent", value:  Mapbox.Unity.Telemetry.TelemetryWebgl.GetUserAgent());
        ...
        {
            TelemetryWebgl.<PostWWW>d__8 val_1 = new TelemetryWebgl.<PostWWW>d__8();
            .<>1__state = 0;
            if(val_1 != null)
            {
                    .url = url;
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public TelemetryWebgl()
        {
        
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        private static TelemetryWebgl()
        {
            Mapbox.Unity.Telemetry.TelemetryWebgl._instance = new Mapbox.Unity.Telemetry.TelemetryFallback();
        }
