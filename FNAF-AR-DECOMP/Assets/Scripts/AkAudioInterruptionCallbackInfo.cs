...
public class AkAudioInterruptionCallbackInfo : IDisposable
{
    ...
    // Properties
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public bool bEnterInterruption { get; }
    ...
    public virtual void Dispose()
    {
                ...
                if(this.swigCMemOwn != false)
        {
            ...
            AkSoundEnginePINVOKE.CSharp_delete_AkAudioInterruptionCallbackInfo(jarg1:  this.swigCPtr);
        }
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public bool get_bEnterInterruption()
    {
        return AkSoundEnginePINVOKE.CSharp_AkAudioInterruptionCallbackInfo_bEnterInterruption_get(jarg1:  this.swigCPtr);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public AkAudioInterruptionCallbackInfo()
    {
        this.swigCMemOwn = true;
        this.swigCPtr = AkSoundEnginePINVOKE.CSharp_new_AkAudioInterruptionCallbackInfo();
    }
