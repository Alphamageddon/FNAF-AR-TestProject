...
public class AkPositionArray : IDisposable
{
    ...
    {
        IntPtr val_3 = System.Runtime.InteropServices.Marshal.AllocHGlobal(cb:  (in_Count + (in_Count << 3)) << 2);
        this.m_Buffer = val_3;
    ...
    public void Add(UnityEngine.Vector3 in_Pos, UnityEngine.Vector3 in_Forward, UnityEngine.Vector3 in_Top)
    {
        ...
        if((this.<Count>k__BackingField) < this.m_MaxCount)
        {
            ...
            val_36 = val_36 + 4;
            uint val_39 = this.<Count>k__BackingField;
            this.m_Current = System.IntPtr.op_Explicit(value:  val_36);
            val_39 = val_39 + 1;
            this.<Count>k__BackingField = val_39;
            return;
        }
        
        System.IndexOutOfRangeException val_38 = new System.IndexOutOfRangeException(message:  "Out of range access in AkPositionArray");
    }
