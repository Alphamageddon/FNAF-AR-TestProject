...
namespace Game.Server
{
    ...
    public class GiveAllModsRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void GiveAllMods()
        {
            GameSparks.Api.Requests.LogEventRequest val_1 = new GameSparks.Api.Requests.LogEventRequest();
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "GIVE_ALL_MODS");
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public GiveAllModsRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525156093696] = eventHandler;
        }
