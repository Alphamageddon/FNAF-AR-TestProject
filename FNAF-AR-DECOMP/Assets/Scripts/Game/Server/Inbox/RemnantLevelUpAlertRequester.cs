...
namespace Game.Server.Inbox
{
    ...
    public class RemnantLevelUpAlertRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void SendMessage()
        {
            ...
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "ESSENCE_LEVEL_UP");
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public RemnantLevelUpAlertRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525204824368] = eventHandler;
        }
