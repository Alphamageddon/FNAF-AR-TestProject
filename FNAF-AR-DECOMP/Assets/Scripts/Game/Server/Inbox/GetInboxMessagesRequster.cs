...
namespace Game.Server.Inbox
{
    ...
    public class GetInboxMessagesRequster : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void GetInboxMessages()
        {
            ...
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "GET_INBOX_MESSAGES");
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public GetInboxMessagesRequster(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525202845984] = eventHandler;
        }
