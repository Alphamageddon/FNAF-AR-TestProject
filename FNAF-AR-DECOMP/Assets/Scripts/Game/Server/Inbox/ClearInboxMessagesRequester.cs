...
namespace Game.Server.Inbox
{
    ...
    public class ClearInboxMessagesRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void ClearInbox()
        {
            ...
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "CLEAR_INBOX_MESSAGES");
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public ClearInboxMessagesRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525202580912] = eventHandler;
        }
