...
namespace Game.Server
{
    ...
    public class PlayerDataRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public PlayerDataRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525158239840] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void GetPlayerData()
        {
            GameSparks.Api.Requests.LogEventRequest val_1 = new GameSparks.Api.Requests.LogEventRequest();
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "GET_PLAYER_DATA");
