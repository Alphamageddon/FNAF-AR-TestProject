...
namespace Game.Server
{
    ...
    public class DailyChallengeDataRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public DailyChallengeDataRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525155418672] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void RequestDailyChallenges()
        {
            GameSparks.Api.Requests.LogEventRequest val_1 = new GameSparks.Api.Requests.LogEventRequest();
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "REFRESH_DAILY_CHALLENGES");
