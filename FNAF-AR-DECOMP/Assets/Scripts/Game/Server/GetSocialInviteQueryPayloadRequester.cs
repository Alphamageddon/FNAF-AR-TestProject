...
namespace Game.Server
{
    ...
    public class GetSocialInviteQueryPayloadRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public GetSocialInviteQueryPayloadRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525164828000] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void QueryPayload(string payload)
        {
            GameSparks.Api.Requests.LogEventRequest val_1 = new GameSparks.Api.Requests.LogEventRequest();
            if(val_1 != null)
            {
                    GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "QUERY_PAYLOAD");
            }
            else
            {
                    GameSparks.Api.Requests.LogEventRequest val_3 = val_1.SetEventKey(eventKey:  "QUERY_PAYLOAD");
            }
