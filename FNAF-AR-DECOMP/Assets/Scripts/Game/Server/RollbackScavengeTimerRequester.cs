...
namespace Game.Server
{
    ...
    public class RollbackScavengeTimerRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public RollbackScavengeTimerRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525161593920] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void Rollback()
        {
            GameSparks.Api.Requests.LogEventRequest val_1 = new GameSparks.Api.Requests.LogEventRequest();
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "ROLLBACK_SCAVENGE_TIMER");
