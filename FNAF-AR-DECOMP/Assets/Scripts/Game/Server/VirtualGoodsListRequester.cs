...
namespace Game.Server
{
    ...
    public class VirtualGoodsListRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public VirtualGoodsListRequester(Game.Server.LogEventHandler eventHandler)
        {
        ...
        public void RequestVirtualGoods()
        {
            ...
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "GET_STORE_ITEMS");
