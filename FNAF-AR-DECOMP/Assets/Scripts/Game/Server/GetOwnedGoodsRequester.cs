...
namespace Game.Server
{
    ...
    public class GetOwnedGoodsRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public GetOwnedGoodsRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525165382688] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void GetOwnedGoods()
        {
            GameSparks.Api.Requests.LogEventRequest val_1 = new GameSparks.Api.Requests.LogEventRequest();
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "GET_OWNED_GOODS");
