...
namespace Game.Server
{
    ...
    public class CPUInventoryRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public CPUInventoryRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525156760432] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void GetCPUInventory()
        {
            GameSparks.Api.Requests.LogEventRequest val_1 = new GameSparks.Api.Requests.LogEventRequest();
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "GET_CPU_INVENTORY");
