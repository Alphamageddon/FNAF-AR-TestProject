...
namespace Game.Server
{
    ...
    public class GiveAllCPURequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public GiveAllCPURequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525155683760] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void GiveAllCPUs()
        {
            GameSparks.Api.Requests.LogEventRequest val_1 = new GameSparks.Api.Requests.LogEventRequest();
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "GIVE_ALL_CPUS_V2");
