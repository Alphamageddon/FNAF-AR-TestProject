...
namespace Game.Server
{
    ...
    public class PlayerWorkshopDataLoader : AbstractRequester
    {
        // Fields
        [System.Runtime.InteropServices.ComVisibleAttribute]
        private const string GET_WORKSHOP_DATA = "GET_WAREHOUSE_DATA_V2";
        ...
        public void Load()
        {
            ...
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "GET_WAREHOUSE_DATA_V2");
        ...
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public PlayerWorkshopDataLoader(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525158649792] = eventHandler;
        }
