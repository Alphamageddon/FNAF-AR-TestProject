...
namespace Game.Server.Requester.DailyChallenge
{
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public class DebugDailyChallengeForceRefresh : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public DebugDailyChallengeForceRefresh(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525208628576] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void RefreshDailyChallenges()
        {
            ...
            GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "TEST_FORCE_REFRESH_DAILY_CHALLENGES");
