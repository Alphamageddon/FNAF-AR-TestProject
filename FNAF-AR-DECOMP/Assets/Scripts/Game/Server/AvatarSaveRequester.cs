...
namespace Game.Server
{
    ...
    public class AvatarSaveRequester : AbstractRequester
    {
        // Methods
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public AvatarSaveRequester(Game.Server.LogEventHandler eventHandler)
        {
            val_1 = new System.Object();
            mem[1152921525159035056] = eventHandler;
        }
        [System.Runtime.InteropServices.ComVisibleAttribute]
        public void SaveAvatarId(string avatarId)
        {
            ...
            if(val_1 != null)
            {
                    GameSparks.Api.Requests.LogEventRequest val_2 = val_1.SetEventKey(eventKey:  "SAVE_AVATAR");
            }
            else
            {
                    GameSparks.Api.Requests.LogEventRequest val_3 = val_1.SetEventKey(eventKey:  "SAVE_AVATAR");
            }
            
            GameSparks.Api.Requests.LogEventRequest val_4 = val_1.SetEventAttribute(key:  "avatarId", value:  avatarId);
