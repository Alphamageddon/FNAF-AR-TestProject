...
public class AkBankCallbackInfo : IDisposable
{
    ...
    public virtual void Dispose()
    {
                ...
                if(this.swigCMemOwn != false)
        {
            ...
            AkSoundEnginePINVOKE.CSharp_delete_AkBankCallbackInfo(jarg1:  this.swigCPtr);
        }
    ...
    {
        return AkSoundEnginePINVOKE.CSharp_AkBankCallbackInfo_bankID_get(jarg1:  this.swigCPtr);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public IntPtr get_inMemoryBankPtr()
    {
        return AkSoundEnginePINVOKE.CSharp_AkBankCallbackInfo_inMemoryBankPtr_get(jarg1:  this.swigCPtr);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public AKRESULT get_loadResult()
    {
        return AkSoundEnginePINVOKE.CSharp_AkBankCallbackInfo_loadResult_get(jarg1:  this.swigCPtr);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public int get_memPoolId()
    {
        return AkSoundEnginePINVOKE.CSharp_AkBankCallbackInfo_memPoolId_get(jarg1:  this.swigCPtr);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public AkBankCallbackInfo()
    {
        this.swigCMemOwn = true;
        this.swigCPtr = AkSoundEnginePINVOKE.CSharp_new_AkBankCallbackInfo();
    }
