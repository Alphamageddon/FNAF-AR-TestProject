...
public sealed class GetAccessToData.ReturnConfigDataEntry : MulticastDelegate
{
    // Methods
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public GetAccessToData.ReturnConfigDataEntry(object object, IntPtr method)
    {
        mem[1152921525244572480] = object;
        mem[1152921525244572488] = method;
        mem[1152921525244572464] = method;
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual void Invoke(ProtoData.CONFIG_DATA.Types.ENTRY configDataEntry)
    {
        var val_22;
        var val_23;
        var val_25;
        ...
        goto label_22;
        label_60:
        ENTRY val_3 = 1152921505197473792 + ((X21 + 72) << 4);
        val_25 = mem[(1152921505197473792 + (X21 + 72) << 4) + 304];
        goto label_58;
        label_18:
        ENTRY val_4 = 1152921505197473792 + (X21 + 72);
        goto label_58;
        label_45:
        val_26 = mem[X21 + 72];
        val_26 = X21 + 72;
        if((configDataEntry & 1) == 0)
        {
            goto label_25;
        }
        ...
        goto label_58;
        label_22:
        var val_28 = (VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(configDataEntry, typeof(val_2), slot: 0);
        goto label_58;
        label_48:
        ...
        label_50:
        val_28 = mem[(((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(configDataEntry, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8];
        val_28 = (((VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(configDataEntry, typeof(val_2), slot: 0) + (1179403647 + X21 + 72)) + 296) + 8;
        goto label_58;
        label_27:
        var val_29 = val_22;
        ...
        goto label_94;
        label_74:
        ENTRY val_14 = 1152921505197473792 + ((X21 + 72) << 4);
        val_31 = mem[(1152921505197473792 + (X21 + 72) << 4) + 304];
        goto label_94;
        label_79:
        ENTRY val_15 = 1152921505197473792 + (X21 + 72);
        goto label_94;
        label_12:
        if((val_1 & 1) == 0)
        {
        ...
        goto label_96;
        label_78:
        val_31 = mem[(VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(configDataEntry, typeof(X21 + 24), slot: 0) + 8];
        val_31 = (VirtualInvokeData*)GetInterfaceInvokeDataFromVTable(configDataEntry, typeof(X21 + 24), slot: 0) + 8;
        goto label_94;
        label_15:
        var val_40 = val_19;
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public virtual System.IAsyncResult BeginInvoke(ProtoData.CONFIG_DATA.Types.ENTRY configDataEntry, System.AsyncCallback callback, object object)
    {
