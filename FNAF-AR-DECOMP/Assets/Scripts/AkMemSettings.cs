...
public class AkMemSettings : IDisposable
{
    ...
    public virtual void Dispose()
    {
                ...
                if(this.swigCMemOwn != false)
        {
            ...
            AkSoundEnginePINVOKE.CSharp_delete_AkMemSettings(jarg1:  this.swigCPtr);
        }
    ...
    public AkMemSettings()
    {
        ...
        this.swigCPtr = AkSoundEnginePINVOKE.CSharp_new_AkMemSettings();
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public void set_uMaxNumPools(uint value)
    {
        AkSoundEnginePINVOKE.CSharp_AkMemSettings_uMaxNumPools_set(jarg1:  this.swigCPtr, jarg2:  value);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public uint get_uMaxNumPools()
    {
        return AkSoundEnginePINVOKE.CSharp_AkMemSettings_uMaxNumPools_get(jarg1:  this.swigCPtr);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public void set_uDebugFlags(uint value)
    {
        AkSoundEnginePINVOKE.CSharp_AkMemSettings_uDebugFlags_set(jarg1:  this.swigCPtr, jarg2:  value);
    }
    [System.Runtime.InteropServices.ComVisibleAttribute]
    public uint get_uDebugFlags()
    {
        return AkSoundEnginePINVOKE.CSharp_AkMemSettings_uDebugFlags_get(jarg1:  this.swigCPtr);
    }
