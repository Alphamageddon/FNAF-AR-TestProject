...
namespace UnityEngine.Rendering.PostProcessing
{
	...
	public sealed class AutoExposure : PostProcessEffectSettings
	{
		...
		{
			if (enabled.value && SystemInfo.supportsComputeShaders && !RuntimeUtilities.isAndroidOpenGL && !RuntimeUtilities.isWebNonWebGPU && RenderTextureFormat.RFloat.IsSupported() && (bool)context.resources.computeShaders.autoExposure)
			{
