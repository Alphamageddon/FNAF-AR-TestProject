...
namespace RuntimeHandle
{
	public class RotationHandle : MonoBehaviour
	{
		...
		public RotationHandle Initialize(RuntimeTransformHandle p_parentTransformHandle)
		{
			...
			{
				_axes.Add(new GameObject().AddComponent<RotationAxis>().Initialize(_parentTransformHandle, Vector3.right, Color.red));
			}
			...
			{
				_axes.Add(new GameObject().AddComponent<RotationAxis>().Initialize(_parentTransformHandle, Vector3.up, Color.green));
			}
			...
			{
				_axes.Add(new GameObject().AddComponent<RotationAxis>().Initialize(_parentTransformHandle, Vector3.forward, Color.blue));
			}
			return this;
		}
